...
//  PowerWAF
//
//  Created by Emile-Hugo Spir on 09/07/2019.
...
/// @param rules JSON blob containing the patterns to work with
/// @return The success (true) or faillure (false) of the init

extern bool powerwaf_initializePowerWAF(const char * ruleName, const char * rules);
